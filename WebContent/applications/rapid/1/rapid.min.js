...
$("#"+d+"dialogue").remove();a=h.append("<div id='"+d+"dialogue' class='dialogue' style='position:absolute;z-index:101;'></div>").children().last();a.css("visibility","hidden");if(links){a.append(links)}a.append(b);if(script){a.append(script)}var j=$(window);$(window).resize();window.setTimeout(function(){a.css("visibility","visible");if(window._rapidmobile){$(window).resize()}},200)}}})}else{window.location=c}}var _userName="";function Action_rapid(k,n,e,o,a,d,j,b,g){var i="GET";var f=null;var m=null;switch(d){case"GETAPPS":f={actionType:d,appId:"rapid"};m=function(p){setData_dataStore("rapid_P0_C210",p,null,{storageType:"S"})};break;case"GETVERSIONS":var n=$("#rapid_P0_C43").val();if(n){f={actionType:d,appId:n};m=function(p){setData_dataStore("rapid_P0_C1063_",p,"versions",{storageType:"S"})}}else{return false}break;case"GETVERSION":var n=$("#rapid_P0_C43").val();var h=$("#rapid_P0_C1044_").val();if(n&&h){f={actionType:d,appId:n,version:h};m=function(p){setData_dataStore("rapid_P0_C1072_",p,null,{storageType:"S"})
}}else{return false}break;case"GETDBCONN":f={actionType:d,appId:$("#rapid_P0_C43").val(),version:$("#rapid_P0_C1044_").val(),index:$("#rapid_P0_C311").find("tr.rowSelect").index()-1};m=function(p){setData_dataStore("rapid_P0_C361",p,"databaseConnection",{storageType:"S"})};break;case"GETSOA":f={actionType:d,appId:$("#rapid_P0_C43").val(),version:$("#rapid_P0_C1044_").val(),index:$("#rapid_P0_C483_").find("tr.rowSelect").index()-1};m=function(p){setData_dataStore("rapid_P0_C528_",p,"webservice",{storageType:"S"});loadSOA(p.webservice)};break;case"GETSEC":f={actionType:d,appId:$("#rapid_P0_C43").val(),version:$("#rapid_P0_C1044_").val(),securityAdapter:$("#rapid_P0_C81").val()};m=function(p){setData_dataStore("rapid_P0_C469_",p,"security",{storageType:"S"})};break;case"GETUSERS":f={actionType:d,appId:"rapid"};m=function(q){setData_grid("rapid_P0_C823_",q,"users",{rowSelect:true,columns:[{field:"name",visible:true,style:"text-align:left;padding-left:10px;"},{field:"description",visible:true,style:"text-align:left;padding-left:10px;padding-right:10px;"},{cellFunction:"",field:"",visible:true,style:""}]});
var p=$("#rapid_P0_C823_").find("tr.rowStyle1,tr.rowStyle2");p.each(function(){var t=$(this).children("td");var s=t.first().html();if(q.currentUser.toLowerCase()!=s.toLowerCase()){var r=t.last();r.html("<button>delete...</button>");r.find("button").click(function(u){if(confirm("Are you sure?")){Action_rapid(u,"rapid","P0",null,"P0_A904_","DELUSER",true)}u.stopPropagation()})}})};break;case"GETUSER":if(j){f={actionType:d,appId:"rapid",version:_appVersion,userName:getData_grid(k,"rapid_P0_C823_","name",{columns:[{field:"name"}]})}}else{f={actionType:d,appId:$("#rapid_P0_C43").val(),version:$("#rapid_P0_C1044_").val(),userName:getData_grid(k,"rapid_P0_C216","userName",{columns:[{field:"userName"}]})}}m=function(p){setData_dataStore("rapid_P0_C243",p,"user",{storageType:"S"})};break;case"GETPARAM":f={actionType:d,appId:$("#rapid_P0_C43").val(),version:$("#rapid_P0_C1044_").val(),index:$("#rapid_P0_C1108_").find("tr.rowSelect").index()-1};m=function(p){setData_dataStore("rapid_P0_C1145_",p,"parameter",{storageType:"S"})
};break;case"GETDEVICE":f={actionType:d,appId:"rapid",version:_appVersion,index:$("#rapid_P0_C1199_").find("tr.rowSelect").index()-1};m=function(p){setData_dataStore("rapid_P0_C1269_",p,"device",{storageType:"S"})};break;case"SAVEAPP":f={actionType:d,appId:$("#rapid_P0_C43").val(),version:$("#rapid_P0_C1044_").val(),status:$("#rapid_P0_C1098_").val(),name:$("#rapid_P0_C392_").val(),saveVersion:$("#rapid_P0_C1077_").val(),title:$("#rapid_P0_C394_").val(),description:$("#rapid_P0_C393_").val(),showControlIds:$("#rapid_P0_C381_").prop("checked"),showActionIds:$("#rapid_P0_C382_").prop("checked"),startPageId:$("#rapid_P0_C644_").val()};break;case"SAVESTYLES":f={actionType:d,appId:$("#rapid_P0_C43").val(),version:$("#rapid_P0_C1044_").val(),styles:$("#rapid_P0_C116").val()};break;case"SAVEDBCONN":f={actionType:d,appId:$("#rapid_P0_C43").val(),version:$("#rapid_P0_C1044_").val(),index:$("#rapid_P0_C311").find("tr.rowSelect").index()-1,name:$("#rapid_P0_C360").val(),driver:$("#rapid_P0_C338").val(),connectionString:$("#rapid_P0_C374").val(),connectionAdapter:$("#rapid_P0_C339").val(),userName:$("#rapid_P0_C340").val(),password:$("#rapid_P0_C341").val()};

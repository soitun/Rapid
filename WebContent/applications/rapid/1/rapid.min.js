...
m=function(p){$(p.controlId).hideDialogue();Event_change_rapid_P0_C43();$("#rapid_P0_C662_").click()};break;case"DELPAGEBACKUP":case"RESTOREPAGEBACKUP":f={actionType:d,appId:$("#rapid_P0_C43").val(),version:$("#rapid_P0_C1044_").val(),backupId:$("#rapid_P0_C678_").find("tr.rowSelect").children("td").first().text()};m=function(p){$(p.controlId).hideDialogue();Event_change_rapid_P0_C43();$("#rapid_P0_C662_").click()};break;case"SAVEAPPBACKUPSIZE":f={actionType:d,appId:$("#rapid_P0_C43").val(),version:$("#rapid_P0_C1044_").val(),backupMaxSize:$("#rapid_P0_C685_").val()};break;case"SAVEPAGEBACKUPSIZE":f={actionType:d,appId:$("#rapid_P0_C43").val(),version:$("#rapid_P0_C1044_").val(),backupMaxSize:$("#rapid_P0_C686_").val()};break;default:f={actionType:d,appId:"rapid"}}if(f){f=JSON.stringify(f)}$.ajax({url:"~?a=rapid&p="+e+"&act="+a,type:"POST",dataType:"json",data:f,error:function(r,p,q){if(r&&r.status&&r.status==401){window.location="login.jsp"}else{if(g){g(r,p,q)}else{alert(r.responseText||"Error : "+p)
